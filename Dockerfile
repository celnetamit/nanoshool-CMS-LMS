...
# Keep a production-only dependency tree without running a second network install.
...
# Keep package metadata available so npm scripts can be executed inside the container.
